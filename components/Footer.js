...
export default function Footer() {
  return (
    <React.Fragment>
      ...
      <a href="mailto:admin@ariasalejandra.tech"><img classNAme={styles.footer} class="hvr-float"alt="email" src="https://media.giphy.com/media/k7Yv2QsOGYTsI0CIDt/giphy.gif" width="30"></img></a>
  ...
  <div >
    <p className={styles.text}>Made with ‎♡ by alejandra</p>
  </div>
      </footer>
    </React.Fragment>
  )
